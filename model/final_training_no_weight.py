...
if __name__ == "__main__":
    ...
    with open(path + "source_final_lower.pickle", "rb") as f: #source2 actuaL: new_source # _23 # final_2
    ...
    torch.save(gen_1.state_dict(), path+"gen_1_complete_stock_no_weight_512")
    torch.save(disc_1.state_dict(), path+"disc_1_complete_stock_no_weight_512")
    torch.save(gen_2.state_dict(), path+"gen_2_complete_stock_no_weight_512")
    torch.save(disc_2.state_dict(), path+"disc2_complete_stock_no_weight_512")
